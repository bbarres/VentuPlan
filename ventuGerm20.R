...
#loading the data
ventGerm20<-read.table("data/PdSVenturia2020.txt",header=TRUE,
...
datamyc<-ventGerm20[ventGerm20$lect_echec!=1,]
...
pdf(file="output/plot_ventu_germ20.pdf",width=7)
...
write.table(CompRez, file="output/results_ventuGerm20.txt",
